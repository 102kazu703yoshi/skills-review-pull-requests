...
1. 次のコメントを入力し、**Submit review** ボタンをクリックします。
   ...
   <img width="300" alt="Submit review ボタン" src="https://github.com/102kazu703yoshi/skills-review-pull-requests/blob/main/.github/images/submit-review-button.png?raw=true" />
